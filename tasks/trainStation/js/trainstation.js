     ...
     setDelay(){
        ...
        Database.forEach((train) => {
            if (trainsDelaysNewValue[train.trainTrack]) {
                ...
                let delay = (pathLength + trainsLengthsArray[train.trainTrack]) / trainsSpeedsArray[train.trainTrack];
                train.trainDelay = trainsDelaysNewValue[train.trainTrack] + delay; 
                trainsDelaysNewValue[train.trainTrack] = trainsDelaysNewValue[train.trainTrack] + delay;
            } 
            else {
